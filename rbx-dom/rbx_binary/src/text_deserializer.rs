            ...
            Type::PhysicalProperties => {
                ...
                for _ in 0..prop_count {
                    ...
                    values.push(match discriminator {
                        ...
                        _ => {
                            // Unknown discriminator, skip this property value
                            // We don't know how many bytes to read, so we'll return Default
                            log::warn!(
                                "Unknown PhysicalProperties discriminator: 0b{:b}",
                                discriminator
                            );
